...
import { fullLogo1Black, fullLogo2Black, registration } from "../assets";
...
const SignupForm = () => {
  ...
  return (
    <div className="flex text-n-8 h-screen">
      <div className="flex flex-col w-[100%] lg:w-[50%] items-center justify-center relative z-1 bg-n-1 py-[4rem] bottom-10 lg:bottom-0">
        ...
        <div className="w-[80%] lg:w-[60%] flex items-end justify-between">
          <div className="flex flex-col">
            <h3 className="text-n-8 h2">Sign up</h3>
            <p className="text-n-4 text-sm tracking-wider">
              Please enter your details.
            </p>
          </div>
          <span className="font-semibold">Step {`${page+1} / 3`}</span>
        </div>
        <form
            ...
            <div className="flex flex-col items-end">
              ...
              <div className="p-3">
                <button
                  ...
                  className="shadow hover:transition-transform hover:-translate-y-1 hover:duration-300 hover:bg-n-8/5 rounded-full p-3"
                >
