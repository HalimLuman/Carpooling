...
const NavbarUser = ({ openLanguage, userInfo, openProfile, handleLanguage }) => {
    const { t } = useTranslation();
    const [dropdown, setDropdown] = useState(openProfile);
    const [languageSwitcher, setLanguageSwitcher] = useState(openLanguage);
        ...
        <div className="flex items-center">
            ...
            <div className="flex items-center ml-auto">
                <div className="relative">
                    <div
                        className="flex items-center justify-center border dark:border-gray-600 hover:shadow dark:hover:shadow-white/30 text-black cursor-pointer px-2 py-2 rounded-full"
                    ...
                    {dropdown && (
                        <div className="absolute right-0 mt-2 w-56 bg-white dark:bg-gray-900 transition duration-300 border border-gray-200 dark:border-gray-600 rounded-lg shadow-lg">
                            <div className="flex flex-col">
                                <div className="pt-2">
                                    <button
                                        onClick={handleGoToProfile}
                                        className="w-full flex items-center px-4 py-3 text-n-8 dark:text-n-1 hover:bg-gray-100 dark:hover:bg-n-1/10 dark:transition dark:duration-300"
                                    >
                                        <CiUser size={22} />
                                    ...
                                    <Link
                                        to="/dashboard"
                                        className="flex items-center px-4 py-3 text-n-8 dark:text-n-1 hover:bg-gray-100 dark:hover:bg-n-1/10 dark:transition dark:duration-300"
                                    >
                                        <IoIosNotificationsOutline size={22} />
                                        <span className="ml-3">{t('GENERAL.Navbar.notification')}</span>
                                    </Link>
                                </div>
                                ...
                                <div className="pb-2">
                                    ...
                                    <button
                                        ...
                                        className="flex items-center w-full px-4 py-3 text-n-8 dark:text-n-1 hover:bg-gray-100 dark:hover:bg-n-1/10 dark:transition dark:duration-300"
                                    >
                                        <CiLogout size={22} />
