...
const NavbarMain = () => {
  ...
  return (
    <div
      className={`fixed h-[70px] top-0 left-0 w-full z-50 shadow dark:shadow-white/10 border-n-2 lg:bg-n-1 dark:bg-neutral-950 dark:shadow-md-white lg:backdrop-blur-sm ${
                ...
                <div className="absolute right-0 mt-2 w-56 bg-white dark:bg-neutral-950 border border-gray-200 dark:border-neutral-700 rounded-lg shadow-lg">
                  <div className="flex flex-col py-2">
                    ...
                    <div className="pb-2">
                      ...
                      <Link to="/login" className="flex items-center border-b border-t border-neutral-200 dark:border-neutral-600 px-4 py-3 text-n-8 dark:text-n-1 hover:bg-gray-100 dark:hover:bg-n-1/10">
                        <button className="">
                          Sign in
                        </button>
                      </Link>
                      <Link to="/register" className="flex items-center  px-4 py-3 text-n-8 dark:text-n-1 hover:bg-gray-100 dark:hover:bg-n-1/10">
                        <button className="">
                          New account
                        </button>
                      </Link>
