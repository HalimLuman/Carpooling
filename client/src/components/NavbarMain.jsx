...
import { MdLogout, MdOutlineModeOfTravel, MdOutlineLanguage } from "react-icons/md";
...
const NavbarMain = () => {
  ...
  return (
    <div className={`fixed top-0 left-0 w-full z-50 shadow border-n-2 lg:bg-n-1 lg:backdrop-blur-sm ${openNavigation ? "bg-n-1" : "bg-n-1/90 backdrop-blur-sm"}`}>
          ...
          <div className="flex items-center">
            <div className="hidden lg:flex items-center ml-auto">
              <div className="relative">
                <div className="text-n-8 cursor-pointer rounded-full mx-2" onClick={() => setOpenLanguage(!openLanguage)}>
                  ...
                  <div className="absolute mt-4 w-max bg-white border border-gray-200 rounded-lg shadow-lg">
                    <div className="flex flex-col">
                      {Object.keys(lngs).map((lng) => (
                        <button key={lng} onClick={() => handleLanguage(lng)} className="px-4 py-2 text-black hover:bg-gray-100 w-full text-left">
                          {lngs[lng].nativeName}
                        </button>
                      ))}
                    </div>
            ...
            <Link to="/account/payments-payouts" className="mx-2 hidden lg:block">
            ...
            <div className="flex items-center ml-auto">
              <div className="relative">
                <div className="flex items-center justify-center border hover:shadow text-black cursor-pointer px-4 py-2 rounded-full" onClick={() => setOpenProfile(!openProfile)}>
                  ...
                  <h3 className="ml-3 mt-[0.1rem] hidden lg:block">{userInfo.name}</h3>
