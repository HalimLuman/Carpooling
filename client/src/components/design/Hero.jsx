...
export const Gradient = () => {
  return (
    <>
      <div className="relative z-1 h-6 mx-2.5 bg-amber-600 opacity-70 shadow-xl rounded-b-[1.25rem] lg:h-3 lg:mx-8" />
      <div className="relative z-1 h-6 mx-6 bg-amber-500 opacity-70 shadow-xl rounded-b-[1.25rem] lg:h-3 lg:mx-20" />
    </>
  );
};
...
export const BottomLine = () => {
  return (
    <>
      <div className="hidden absolute top-[45.5rem] left-10 right-10 h-0.25 bg-n-8/20 dark:hidden transition duration-500 pointer-events-none xl:block z-1" />

      <PlusSvg className="hidden absolute top-[45.2rem] left-[2.1875rem] z-2 pointer-events-none xl:block dark:hidden " />

      <PlusSvg className="hidden absolute top-[45.2rem] right-[2.1875rem] z-2 pointer-events-none xl:block dark:hidden" />
    </>
  );
};
