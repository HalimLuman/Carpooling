...
export const BottomLine = () => {
  return (
    <>
      <div className="hidden absolute top-[47.3rem] left-10 right-10 h-0.25 bg-n-8/20 pointer-events-none xl:block" />

      <PlusSvg className="hidden absolute top-[47rem] left-[2.1875rem] z-2 pointer-events-none xl:block" />

      <PlusSvg className="hidden absolute top-[47rem] right-[2.1875rem] z-2 pointer-events-none xl:block" />
    </>
  );
};
