      ...
      <div className="container relative z-2">
        ...
        <div className="flex flex-wrap lg:grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 2xl:gap-10 mb-10 mt-8">
          {benefits.map((item, index) => (
            <div
              className="block relative p-0.5 bg-white border border-n-2 rounded-xl shadow-lg hover:shadow-xl dark:bg-gray-800 dark:border-gray-700"
              key={item.id}
            >
              <div className="relative z-2 flex flex-col min-h-[22rem] p-[2.4rem] bg-white dark:bg-gray-800 rounded-xl">
                ...
                <div className="flex items-center mt-auto justify-between">
                  ...
                  <a className="flex items-center z-5" href="#">
                    <p className="ml-auto font-code text-xs font-bold text-n-8 uppercase tracking-wider hover:text-sky-600 dark:hover:text-sky-600 dark:text-gray-200 ">
                      {t(`HOME.Safety.link`)}
                    </p>
                    <Arrow />
                  </a>
