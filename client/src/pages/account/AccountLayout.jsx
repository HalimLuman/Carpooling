...
const AccountLayout = () => {
    ...
    return (
        <>
            <NavbarSettings />
            <div className='mt-[4rem] dark:bg-gray-900 transition duration-300 text-white'>
                <Outlet/>
            </div>
            <div className='border-t border-gray-700 dark:border-gray-800 mb-[4rem] lg:mb-0'>
                <Footer />
            </div>
            <div className='xl:hidden'>
            <div className='w-full border-t dark:border-gray-700 xl:hidden bottom-0 fixed z-10 bg-n-1 dark:bg-gray-900'>
